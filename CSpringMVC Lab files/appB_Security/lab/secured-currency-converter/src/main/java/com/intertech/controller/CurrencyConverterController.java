...
public class CurrencyConverterController {
	...
	@RequestMapping("rates.request")
	protected ModelAndView rates() {
		HashMap<String, Double> map = new HashMap<String, Double>();
		map.put("euro", converterService.getEuroRate());
		map.put("yen", converterService.getYenRate());
		return new ModelAndView("rates", map);
	}
}

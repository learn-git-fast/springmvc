...
<form:form method="post"
	...
	<table border="1">
		...
		<tr>
			<td bgcolor="cyan"><spring:message code="editcontact.label.firstname"/></td>
			<td><form:input path="firstName" size="40" /><font
				color="#FF0000"><form:errors path="firstName" /></font></td>
		</tr>
		<tr>
			<td bgcolor="cyan"><spring:message code="editcontact.label.lastname"/></td>
		...
		<tr>
			<td bgcolor="cyan"><spring:message code="editcontact.label.married"/></td>
			<td><form:checkbox path="married" /><font color="#FF0000"><form:errors
				path="married" /></font></td>
		</tr>
		<tr>
			<td bgcolor="cyan"><spring:message code="editcontact.label.children"/></td>
			<td><form:input path="children" size="5" /><font
				color="#FF0000"><form:errors path="children" /></font></td>
		</tr>
		<tr>
			<td><input type="submit" name="_eventId_contactSaved" value="<spring:message code="editcontact.button.save"/>" /></td>
			<td><input type="reset" value="<spring:message code="editcontact.button.reset"/>" /></td>
		</tr>
	</table>
	<a href="index.jsp"><spring:message code="editcontact.link.mainpage"/></a>
	<form:hidden path="id" />
</form:form>
</body>
</html>